...
const MainPanel = props =>{  
  ...
  const [isSearchFiltersPanelOpen, setIsSearchFiltersPanelOpen] = useState(!!secondaryFilters && !!isSearchFiltersPanelOpen);

  //other way to setState
  //const [isSearchFiltersPanelOpen, setIsSearchFiltersPanelOpen] = useState(false);
  // if(!!secondaryFilters && !!isSearchFiltersPanelOpen){    
  //   setIsSearchFiltersPanelOpen(!!secondaryFilters && !!isSearchFiltersPanelOpen);
  // }
  ...
  const searchFiltersPanelProps = !!secondaryFilters
    ? {
      isSearchFiltersPanelOpen: isSearchFiltersPanelOpen,
      toggleSearchFiltersPanel: isOpen => {
        setIsSearchFiltersPanelOpen(isOpen);
      },
    ...
    <div className={classes}>
      ...
      <div className={css.showMap}>
        <label className={css.switch}>
          <input type="checkbox" id="checkBox" defaultChecked onClick ={()=>handleShowMap()} />
